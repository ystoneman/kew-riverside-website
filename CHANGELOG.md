...
- **Drafts and returning.** The letter and public name are kept on this device for seven days (never the email or council details), with Clear draft. After Send, coming Back asks “Did your letter arrive?”, in view, with the official-form step until 16 October. A letter the thank-you page confirmed is cleared rather than offered again.
...
- **Share ideas.** Visible category cards replace the dropdown. The meeting card is dated until 29 September, then becomes “A question about the proposal” and moves last.
- **Thank-you page** (`sent.html`, not indexed and not measured by analytics). Neutral unless this tab recorded a letter or idea in the last 30 minutes. After a letter: make it official first (copy, open the form, calendar reminder), then share with another parent, then read others' letters. Dated parts switch on 13 and 17 October. The page needs Formspree's redirect, which requires a paid plan; until then the letters page carries the official step.
