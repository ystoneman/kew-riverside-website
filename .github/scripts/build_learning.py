...
<p class="section-lead">In <strong>2025</strong>, <strong>73%</strong> of Kew’s Year 6 pupils met the expected standard in reading, writing and maths combined, compared with <strong>62% in England</strong> and <strong>78% in Richmond</strong>.</p>
...
<p class="data-context" id="newer-darell-results"><strong>Newer context:</strong> Darell’s <a href="{e(data['sources'][4]['url'])}">2025/26 school announcement</a> reports 68% for all 22 pupils, including specialist resource provision, against a <a href="{e(data['sources'][5]['url'])}">provisional England figure of 63%</a>. Comparable Kew 2026 results were not located. These are different years and publication stages, so they do not support a like-for-like Kew/Darell comparison.</p>
...
</details><details class="data-disclosure"><summary>A question to use in your response</summary><aside class="reading-note"><p><strong>A useful consultation question:</strong> how have the options been assessed against Kew’s existing curriculum, opportunities for pupils to support younger children, and continuity of teaching and relationships—and what would each option preserve or change?</p><p><a href="proposal.html#questions">Read the other questions about the proposal</a> · <a href="feedback.html?kind=evidence#feedback-form">Share evidence or a correction</a>.</p></aside></details></section>
'''
