...
<p class="data-context">The annual budget connecting them has not been supplied in the reviewed public records. The reserve alone does not establish financial sustainability; the projected deficit is not an annual loss or a measured amount needed to keep the school open.</p>
...
<p class="section-lead">One short-term forecast was close overall: <strong>{total['forecastPupils']} pupils forecast, {total['actualPupils']} counted</strong> across the Kew planning area in <strong>{e(check['targetAcademicYear'])}</strong>. Reception was underestimated: {reception['forecastPupils']} forecast, {reception['actualPupils']} counted.</p>
