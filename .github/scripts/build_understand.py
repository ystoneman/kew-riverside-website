...
<section class="understand-hero" id="top"><div><p class="eyebrow">The situation, explained visually</p><h1>See the picture.<br>Ask better questions.</h1><p class="intro">Explore pupil trends, school places, finances, forecast checks and the evidence on learning and results. Each answer names its measurement date and distinguishes reported actuals from council projections.</p><p class="source-note">School comparisons checked 22 September 2026 · finance and forecasts checked 23 September 2026<br>These sections use different dates and sources; the date beside each finding shows what it measures.</p></div><nav class="visual-route" aria-label="Explore the comparisons"><p>Start with the question that matters to you.</p><a href="#pupil-trends"><span aria-hidden="true">01</span>Are other schools shrinking?</a><a href="#forecast-checks"><span aria-hidden="true">02</span>How reliable are pupil forecasts?</a><a href="#school-places"><span aria-hidden="true">03</span>Where are the unfilled places?</a><a href="#year-groups"><span aria-hidden="true">04</span>Which year groups are smaller?</a><a href="#budget"><span aria-hidden="true">05</span>What do the school finances show?</a><a href="#learning-and-results"><span aria-hidden="true">07</span>What about learning and results?</a></nav></section>
