...
<aside class="reading-note"><p><strong>A useful question for the council:</strong> what explains the differences within Kew, and which measures could realistically change Kew Riverside’s future intake?</p><p>For the longer borough context, see <a href="evidence.html#borough-context">Richmond’s Reception applications and capacity figures</a>. Applications and pupils already attending school are different measures.</p></aside></div></details></section>
