...
### 4. Pupil impacts
Ask for receiving capacity by year group, provision for special educational needs and disabilities (SEND), journey assessment, continuity, siblings and the equality analysis. Use anonymised examples publicly; share sensitive evidence only through an appropriate official channel.

### 5. The requested decision
Specify the change you seek and which evidence supports it. Make unresolved questions precise enough to be answered. If asking for more work before a decision, identify the missing assessment and explain how it could change the outcome.

## Response structure

1. My connection to the school or area.
2. My requested outcome.
3. The strongest evidence, with document titles, dates and page references.
4. A viable alternative or a precise request for additional appraisal.
...
A petition does not replace a formal consultation response or establish a veto.
...
This is a research snapshot. Check current official material before acting.
