...
- **Drafts and returning.** The letter and public name are kept on this device for seven days and never the email or council details. On Send the draft is marked pending. Coming back without the thank-you page shows “Did your letter arrive?”, focused and in view, with the official-form step until 16 October. A letter the thank-you page confirmed is recognised by a fingerprint and cleared, not offered again.
- **Share ideas.** Visible category cards replace the dropdown. The meeting card is dated before 29 September and becomes a general question afterwards.
- **Thank-you page (`sent.html`).** Neutral unless this tab records a recent letter or idea. After a letter: “Make it official” first (copy, open the form, calendar reminder until 12 October), then sharing with another parent, then reading others' letters. Dated asks retire after 16 October. It needs the form service's redirect, which requires a paid Formspree plan; until then the letters page's return panel carries the official step.
