...
- **Share ideas.** Visible category cards replace the dropdown. The static meeting card is date-neutral for visitors without scripts; scripts add its date before 29 September and make it a general question afterwards. The extra category disclosure stays open without scripts so privacy/removal routes remain visible.
