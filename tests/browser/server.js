...
// HTTP/2 matches GitHub Pages: cancelling a page's in-flight requests resets streams instead of
// closing HTTP/1.1 connections. HTTP/1.1 remains for Playwright's request client and readiness check.
