...
| Participation invitation | Header tiles on every page (labels, tap size, current page, 320 px fit, one-time cue); write-first letters, starters, counter, drafts, Send/Back arrival panel and confirmed letters; dated official asks; optional quotes only with publication; Share ideas cards and meeting dates; thank-you page by kind, age and date; copy fallback; calendar file; link previews |
